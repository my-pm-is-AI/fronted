...
export default function BuildingScene() {
  ...
  // 监听全局 Agent 点击事件
  useEffect(() => {
    const handleAgentClicked = (e: Event) => {
      const customEvent = e as CustomEvent;
      if (customEvent.detail && customEvent.detail.agentName) {
  ...
  return (
    <div className='relative w-full h-full'>
      <Canvas
        ...
        onPointerMissed={() => setSelectedAgent(null)} // 点击空白处关闭卡片
      >
      ...
      {/* 悬浮的人物卡片介绍 */}
      <TeamCardOverlay agentName={selectedAgent} onClose={() => setSelectedAgent(null)} />
    </div>
  );
}
