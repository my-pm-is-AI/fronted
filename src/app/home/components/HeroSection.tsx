...
export default function HeroSection() {
  return (
    <section className="relative flex flex-col items-center px-6 pt-36 pb-8 text-center md:pt-44">
      ...
      {/* Main Title */}
      <motion.h1
        className="mt-8 max-w-4xl text-5xl font-bold leading-[1.08] tracking-tight text-white md:text-7xl lg:text-8xl"
      ...
      >
        Deploy, manage, and scale intelligent AI agents that work alongside your
        team. Built for the enterprises of tomorrow.
      </motion.p>
