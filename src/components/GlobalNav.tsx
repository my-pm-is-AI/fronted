...
const NAV_LINKS = [
  { href: "/publish", label: "发布需求", icon: "✦" },
  { href: "/square", label: "需求广场", icon: "⊞" },
  { href: "/projects", label: "项目历史", icon: "▤" },
  { href: "/workspace", label: "工作空间", icon: "⬡" },
  { href: "/profile", label: "个人中心", icon: "◈" },
];

const PAGE_META: Record<string, { label: string; sub: string }> = {
  "/publish": { label: "发布需求", sub: "NEW PROJECT" },
  "/square": { label: "需求广场", sub: "REQUIREMENT MARKET" },
  "/projects": { label: "项目历史", sub: "MY HISTORY" },
  "/workspace": { label: "工作空间", sub: "AGENT PLATFORM" },
  "/profile": { label: "个人中心", sub: "USER SETTINGS" },
  "/settlement": { label: "结算报告", sub: "PROJECT REPORT" },
};
    ...
    <Link href={href} style={{ textDecoration: "none" }}>
      <div
        ...
        style={{
          ...
          transform,
          transition:
            "transform 0.12s ease, box-shadow 0.12s ease, background 0.12s, color 0.12s, border-color 0.12s",
          borderRadius: 0,
          userSelect: "none",
          whiteSpace: "nowrap",
        }}
